...
class GetToPink(MissionBase):
    ...
    def routine(self):
        ...
        self.runAction(DriveStraightAccurate(150, speed=ACCURATE_SPEED, weights=[0, 0, 2, 1], compensate=True, verbose=True))
        #self.runAction(DriveTurnAction(12))
        SpinMotor(300*SPEED_GEAR_RATIO, -60*ANGLE_GEAR_RATIO).run()
        SpinMotorUntilStalled(-motorCenter.control.limits()[0], duty_limit=70).run()
        self.runAction(DriveStraightAccurate(-50, speed=ACCURATE_SPEED))
        #self.runAction(DriveTurnAction(-12))
        ...
        self.runAction(DriveStraightAccurate(130, speed=ACCURATE_SPEED))
        self.runAction(DriveTurnAction(-20))
        self.runAction(DriveStraightAccurate(-60, speed=ACCURATE_SPEED, verbose=True))
        self.runAction(DriveTurnAction(-20))
        self.runAction(DriveStraightAccurate(-40, speed=ACCURATE_SPEED, verbose=True))
        wait_for_button_press()
        self.runAction(DriveStraightAccurate(120))
        self.runAction(DriveTurnAction(-20))
        wait_for_button_press()
        self.runAction(SpinMotor(200*SPEED_GEAR_RATIO, 90*ANGLE_GEAR_RATIO))
        self.runAction(DriveTurnAction(35))
        self.runAction(DriveStraightAccurate(-100))
        self.runAction(DriveTurnAction(90))
        wait_for_button_press()
        self.runAction(DriveCurveAction(-450, 45))
