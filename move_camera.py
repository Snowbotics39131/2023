...
class GetToPink(MissionBase):
    ...
    def routine(self):
        ...
        wait_for_button_press()
        self.runAction(DriveStraightAccurate(160, speed=ACCURATE_SPEED))
        wait_for_button_press()
        self.runAction(DriveTurnAction(-80))
        wait_for_button_press()
        self.runAction(DriveStraightAccurate(40))
        wait_for_button_press()
        self.runAction(DriveTurnAction(-15))
        wait_for_button_press()
        self.runAction(SpinMotor(200*SPEED_GEAR_RATIO, 90*ANGLE_GEAR_RATIO))
        ...
        wait_for_button_press()
        self.runAction(DriveStraightAccurate(-150, speed=TRAVEL_SPEED))
        wait_for_button_press()
        self.runAction(DriveTurnAction(-45))
        wait_for_button_press()
        self.runAction(DriveStraightAccurate(-200))
        wait_for_button_press()
        self.runAction(SpinMotor(200*SPEED_GEAR_RATIO, -90*ANGLE_GEAR_RATIO))
        wait_for_button_press()
